import { s as setContext, a as split_css_unit, c as create_ssr_component, e as escape, b as add_attribute, d as compute_slots, f as add_styles, g as subscribe, h as createEventDispatcher, i as spread, j as escape_object, v as validate_component, m as missing_component, k as each } from "../../chunks/ssr.js";
import { w as writable } from "../../chunks/index.js";
import { i as initializeModalStore, a as initializeToastStore, p as prefersReducedMotionStore, g as getModalStore, b as getToastStore } from "../../chunks/ProgressBar.svelte_svelte_type_style_lang.js";
...
const RestaurantResult = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $modalStore, $$unsubscribe_modalStore;
  const modalStore = getModalStore();
  $$unsubscribe_modalStore = subscribe(modalStore, (value) => $modalStore = value);
  let name = "";
  ...
  $$unsubscribe_modalStore();
  return `<div class="p-6 max-w-sm mx-auto bg-slate-800 rounded-xl shadow-md space-y-4 relative"><button type="button" class="absolute top-2 right-2 p-1 text-white hover:text-gray-300" data-svelte-h="svelte-1ga4bwh"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button> <h2 class="text-xl font-semibold" data-svelte-h="svelte-1y3pwws">Restaurant trouvé</h2> <p><strong data-svelte-h="svelte-d6ywpi">👨‍🍳 Restaurant :</strong> ${escape(name)}</p> <p><strong data-svelte-h="svelte-10zwlb9">📍 Adresse :</strong> ${escape(address)}</p> <p><strong data-svelte-h="svelte-vftl3h">⭐️ Note :</strong> ${escape(rating)}</p></div>`;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  getModalStore();
  const modalRegistry = {
    restaurantResult: { ref: RestaurantResult }
  };
  return ` ${validate_component(Toast, "Toast").$$render($$result, {}, {}, {})} ${validate_component(Modal, "Modal").$$render($$result, { components: modalRegistry }, {}, {})} ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
